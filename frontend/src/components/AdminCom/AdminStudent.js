...
gradeOptions : [
  ...
  EditBtnClick = (row) => {
    {row.filename && import(`./public/${row.filename}`).then(image => {
     this.setState({
       image:image
...
<Modal size="lg" isOpen={this.state.managEditModal} toggle={this.toggleManageEditModal}>
        <ModalHeader toggle={this.toggleManageEditModal}>User Details
         ...
         <Formik
          ...
          onSubmit={async(values, { setSubmitting }) => {
            await axios.put(`http://localhost:3050/update/${values.uniqueid}`,values).then(r => r.data.success ? toastr.success("Updated Successfully") : toastr.error("Failed to Upload")).catch(e => toastr.error(e))
            setSubmitting(false);
            this.toggleManageEditModal()
            this.dataFilter()
          }}
            ...
            <Form className="av-tooltip tooltip-label-bottom">
                ...
                <Form>
                  <Row>
                    ...
                    <div className="form-group">
                        ...
                        <Field name="studentname" className="form-control" type="text" disabled />
                    </div>
                    </Col>
                    <Col md={4}>
                    <div className="form-group">
                        <label htmlFor="email">Email Address</label>
                        <Field name="email" className="form-control" type="email" disabled />
                    </div>
                    </Col>
                    <Col md={2}>
                    <div className="form-group">
                        <label htmlFor="studentage">Age</label>
                        <Field name="studentage" className="form-control" type="text" disabled />
                    </div>
                    </Col>
                    <Col md={2}>
                    <div className="form-group">
                        <label htmlFor="grade">Grade</label>
                        <Field name="grade" className="form-control" type="text" disabled />
                    </div>
                    </Col>
                  </Row>
                  <Row>
                    ...
                    <div className="form-group">
                        ...
                        <Field name="phonenumber" className="form-control" type="text" disabled />
                    </div>
                    </Col>
                    <Col>
                    <div className="form-group">
                        <label htmlFor="city">City</label>
                        <Field name="city" className="form-control" type="text" disabled />
                    </div>
                    </Col>
                    <Col>
                    <div className="form-group">
                        <label htmlFor="region">Region </label>
                        <Field name="region" className="form-control" type="text" disabled/>
                    </div>
                    </Col>
                  </Row>
                  <Row>
                  <Col>
                    <div className="form-group">
                         <label className="requiredField" htmlFor="mark1">Mark-1 </label>
                        <Field as="select" name="mark1" class="custom-select">
                    ...
                    <Col>
                    <div className="form-group">
                         <label htmlFor="mark2" className="requiredField">Mark-2 </label>
                        <Field as="select" name="mark2" class="custom-select">
                        <option selected>Choose the mark</option>
                         <option value="1">1</option>
                         <option value="2">2</option>
                         <option value="3">3</option>
                    ...
                    <Col>
                    <div className="form-group">
                    <label htmlFor="signedby" className="requiredField">SignedBy</label>
                    <div class="input-group mb-3">
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <Field type="checkbox" name="status" aria-label="Checkbox for following text input" />
                          
                        </div>
                      </div>
                      <Field type="text" name="signedby" class="form-control" aria-label="Text input with checkbox" />
                    ...
                    {errors.status && (
                      <p className="error mr-4" style={{alignItems:"flex-end"}}>{errors.status}</p>
                      )}
                    {errors.signedby && (
                      <p className="ml-4 error" style={{alignItems:"flex-start"}}>{errors.signedby}</p>
                      )}
                      </span>
                    </div> 
                    </Col>
              ...
              <Row><Col md={8}>
                    <div className="form-group">
                        ...
                        <Field name="remark" className="form-control" as="textarea" />
                    </div>
              </Col>
              <Col md={4}>
              <SimpleReactLightbox>
      <SRLWrapper>
                        <a href={this.state.image['default']}>
                        <img src={this.state.image['default']} style={{height: '150px',width: '150px'}} title="" alt="" />
                         </a>
                         {/* <a
                           href={image}
                           download
                    ...
                    <Col sm={6}>
                      <div className="text-sm-right d-none d-sm-block">
                        <FormGroup className="float-sm-right ">
                          <Button type="submit" color="primary"disabled={isSubmitting}>{isSubmitting ? "Please wait..." : "Submit"}
                          </Button>
